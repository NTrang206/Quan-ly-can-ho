    ...
    <div className="min-h-screen bg-[#f0f4f8] flex flex-col justify-between py-6 px-4 sm:px-6">
      ...
      <div className="max-w-5xl w-full mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-sky-50 border border-sky-100 flex items-center justify-center p-1.5 shadow-xs shrink-0">
            <svg
              viewBox="0 0 48 48"
              fill="none"
          ...
          <div>
            <div className="text-[20px] font-extrabold text-[#1d4ed8] tracking-tight leading-none">
              Dwell
            </div>
            <div className="text-[7.5px] font-bold text-slate-500 uppercase tracking-tight leading-tight mt-1">
              Hệ thống căn hộ cho thuê toàn quốc
            </div>
            <div className="text-[7px] font-medium text-slate-400 uppercase tracking-tight leading-tight mt-0.5">
